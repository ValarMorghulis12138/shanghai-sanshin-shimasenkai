...
export const en: Translations = {
  ...
  admin: {
    ...
    eventDescriptionPlaceholder: 'Event details, with line breaks...',
    eventDescriptionHint: 'Press Enter for a new line, or leave a blank line for a new paragraph. Use the toolbar for bold, italic, links, and lists.',
    eventDescriptionPreview: 'Preview',
    formatBold: 'Bold',
    formatItalic: 'Italic',
    formatLink: 'Link',
    formatList: 'List',
